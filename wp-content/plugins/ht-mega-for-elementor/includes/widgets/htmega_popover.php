                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .htmega-popover span svg' => 'font-size: {{SIZE}}{{UNIT}};',
                            ],
                            'condition'=>[
                                'popover_button_type'=>'icon',
        ...
        ?>
            ...
            <div <?php echo $this->get_render_attribute_string( 'htmega_popover_attr' ); ?>>
                <?php
                    ...
                    echo sprintf('<span class="%1$s" data-container=".htmega-popover-container-%6$s" data-toggle="popover" data-placement="%2$s" data-content="%3$s" title="%4$s">%5$s</span>', $active_class, $settings['popover_dir'], $settings['popover_text'], $settings['popover_header_text'], $button_txt, $id );
                ?>
            </div>
