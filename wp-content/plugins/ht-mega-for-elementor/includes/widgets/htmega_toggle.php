...
class HTMega_Elementor_Widget_Toggle extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if( !empty( $settings['toggle_button_normal_icon']['value'] ) ){
            $button_normal_txt = $settings['toggle_button_normal_title'].HTMega_Icon_manager::render_icon( $settings['toggle_button_normal_icon'], [ 'aria-hidden' => 'true' ] );
        }

        if( !empty( $settings['toggle_button_open_title'] ) ){
            $button_open_txt = $settings['toggle_button_open_title'];
        }
        if( !empty( $settings['toggle_button_open_icon']['value'] ) ){
            $button_open_txt = $settings['toggle_button_open_title'].HTMega_Icon_manager::render_icon( $settings['toggle_button_open_icon'], [ 'aria-hidden' => 'true' ] );
        }
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'htmega_toggle_attr' ); ?> >
                ...
                <div class="htmega-toggle-button">
                    <?php
                        echo sprintf( '<a href="#" class="togglebutton-%2$s normal_btn">%1$s</a>', $button_normal_txt, $id );
                        echo sprintf( '<a href="#" class="togglebutton-%2$s opened_btn">%1$s</a>', $button_open_txt, $id );
                    ?>
                </div>
