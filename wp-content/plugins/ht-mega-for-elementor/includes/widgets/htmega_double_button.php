...
class HTMega_Elementor_Widget_Double_Button extends Widget_Base {
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .htmega-doublebutton a.htmega-doule-btn.btn-one' => 'text-align: {{VALUE}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-doublebutton a.htmega-doule-btn.btn-two, {{WRAPPER}} .before_bg a.htmega-doule-btn.btn-two::before',
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .htmega-doublebutton a.htmega-doule-btn.btn-two' => 'text-align: {{VALUE}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-doublebutton a.htmega-doule-btn.btn-two:hover, {{WRAPPER}} .before_bg a.htmega-doule-btn.btn-two:hover::before',
                            'separator' => 'before',
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        if ( ! empty( $settings['button_one_link']['url'] ) ) {
            ...
            $button_one_text  = !empty( $settings['button_one_text'] ) ? $settings['button_one_text'] : '';
            $button_one_icon  = !empty( $settings['button_one_icon']['value'] ) ? '<span>'.HTMega_Icon_manager::render_icon( $settings['button_one_icon'], [ 'aria-hidden' => 'true' ] ).'</span>' : '';
            
            $this->add_render_attribute( 'urlone', 'href', $settings['button_one_link']['url'] );

            if ( $settings['button_one_link']['is_external'] ) {
                $this->add_render_attribute( 'urlone', 'target', '_blank' );
            }

            if ( ! empty( $settings['button_one_link']['nofollow'] ) ) {
                $this->add_render_attribute( 'urlone', 'rel', 'nofollow' );
            }
            ...
            $button_one_text = sprintf( '<a %1$s>%2$s%3$s</a>', $this->get_render_attribute_string( 'urlone' ), $button_one_icon, $button_one_text );
        }

        // Button Two
        $button_two_text  = !empty( $settings['button_two_text'] ) ? $settings['button_two_text'] : '';
        $button_two_icon  = !empty( $settings['button_two_icon'] ) ? '<span>'.HTMega_Icon_manager::render_icon( $settings['button_two_icon'], [ 'aria-hidden' => 'true' ] ).'</span>' : '';

        if ( ! empty( $settings['button_two_link']['url'] ) ) {
            
            $this->add_render_attribute( 'urltwo', 'href', $settings['button_two_link']['url'] );

            if ( $settings['button_two_link']['is_external'] ) {
                $this->add_render_attribute( 'urltwo', 'target', '_blank' );
            }

            if ( ! empty( $settings['button_two_link']['nofollow'] ) ) {
                $this->add_render_attribute( 'urltwo', 'rel', 'nofollow' );
            }
            ...
            $button_two_text = sprintf( '<a %1$s>%2$s%3$s</a>', $this->get_render_attribute_string( 'urltwo' ), $button_two_icon, $button_two_text );
        }
